...
public class SmartTradeResource {
    ...
    private static final String ENTITY_NAME = "servicebosSmartTrade";
    ...
    public ResponseEntity<SmartTrade> updateSmartTrade(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, smartTrade.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<SmartTrade> partialUpdateSmartTrade(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, smartTrade.getId())
        );
    }
