...
public class CurrenciesResource {
    ...
    private static final String ENTITY_NAME = "servicebosCurrencies";
    ...
    public ResponseEntity<Currencies> updateCurrencies(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, currencies.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Currencies> partialUpdateCurrencies(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, currencies.getId())
        );
    }
