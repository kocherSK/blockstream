...
public class WalletResource {
    ...
    private static final String ENTITY_NAME = "servicebosWallet";
    ...
    public ResponseEntity<Wallet> updateWallet(@PathVariable(value = "id", required = false) final String id, @RequestBody Wallet wallet)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, wallet.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Wallet> partialUpdateWallet(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, wallet.getId()));
    }
